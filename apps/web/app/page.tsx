...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Top Banner Notice */}
      <aside aria-label="Legal Disclaimer" className="bg-amber-950/40 border-b border-amber-800/40 px-4 py-2 text-center text-xs font-medium text-amber-300">
      ...
      <header className="border-b border-slate-800/80 bg-slate-950/70 backdrop-blur sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-amber-500 to-amber-300 flex items-center justify-center font-serif font-black text-slate-950 text-xl shadow-lg shadow-amber-500/20">
              L
            </div>
          ...
          <nav className="flex items-center gap-6 text-sm">
            <a href="#privilege" className="text-slate-400 hover:text-white transition">
              Privilege Security
            </a>
            ...
            <a
              href="/onboarding"
              className="bg-amber-500 hover:bg-amber-400 text-slate-950 font-semibold px-4 py-2 rounded-md shadow-md transition flex items-center gap-1.5"
            >
      ...
      <main className="flex-1">
        <section className="max-w-5xl mx-auto px-6 pt-24 pb-20 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900 border border-slate-800 text-amber-400 text-xs font-semibold mb-6">
            <ShieldCheck className="w-4 h-4 text-amber-400" />
            Zero Data Retention · ABA Formal Opinion 512 Compliant
          </div>

          <h1 className="text-5xl md:text-6xl font-serif font-bold tracking-tight text-white mb-6 leading-tight">
            Every conversation on the record. <br />
            <span className="text-amber-400">Every minute on the invoice.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <a
              href="/onboarding"
              className="w-full sm:w-auto bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold px-8 py-3.5 rounded-lg shadow-lg shadow-amber-500/25 transition text-base"
            >
              Start Free Trial (Clio Ready)
            </a>
            <a
              href="#privilege"
              className="w-full sm:w-auto bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-200 font-semibold px-8 py-3.5 rounded-lg transition text-base"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="p-6 rounded-xl bg-slate-900/60 border border-slate-800/80">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">25-Line Legal Format</h3>
            ...
            <div className="p-6 rounded-xl bg-slate-900/60 border border-slate-800/80">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Instant UTBMS Billing</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
            ...
            <div className="p-6 rounded-xl bg-slate-900/60 border border-slate-800/80">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Privileged by Default</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
        ...
        {/* Privilege Section */}
        <section id="privilege" className="py-20 border-t border-slate-900 bg-slate-950/50">
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="space-y-4">
              <div className="p-5 rounded-lg bg-slate-900/40 border border-slate-800 flex items-start gap-4">
                <KeyRound className="w-6 h-6 text-amber-400 mt-1 shrink-0" />
                <div>
                  <h4 className="font-semibold text-white">Envelope Encryption Per Firm</h4>
              ...
              <div className="p-5 rounded-lg bg-slate-900/40 border border-slate-800 flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-white">Zero Vendor Training & Ephemeral Audio</h4>
                  <p className="text-sm text-slate-400 mt-1">
        ...
        <section id="pricing" className="py-20 border-t border-slate-900">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <h2 className="text-3xl font-serif font-bold text-white mb-4">Transparent Law Firm Pricing</h2>
            <p className="text-slate-400 mb-12">No hidden fees. Every minute on the record.</p>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
              <div className="p-8 rounded-xl bg-slate-900 border border-slate-800 relative">
                <h3 className="text-xl font-bold text-white mb-2">Solo Practitioner</h3>
                <div className="text-3xl font-bold text-white mb-4">
                  $79 <span className="text-sm font-normal text-slate-400">/ user / mo</span>
                </div>
                ...
                <a
                  href="/onboarding"
                  className="block text-center w-full py-2.5 bg-slate-800 hover:bg-slate-700 font-semibold rounded-lg text-white transition"
                >
                  Start 14-Day Trial
                </a>
              </div>

              <div className="p-8 rounded-xl bg-slate-900 border-2 border-amber-500/80 relative shadow-xl shadow-amber-500/10">
                ...
                <h3 className="text-xl font-bold text-white mb-2">Small Firm</h3>
                <div className="text-3xl font-bold text-white mb-4">
                  $149 <span className="text-sm font-normal text-slate-400">/ user / mo</span>
                </div>
                <p className="text-sm text-slate-400 mb-6">
      ...
      {/* Footer */}
      <footer className="border-t border-slate-900 py-8 px-6 bg-slate-950 text-center text-xs text-slate-500">
